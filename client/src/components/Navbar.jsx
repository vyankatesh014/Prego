...
const Navbar = () => {
    ...
    const Logout = async () => {
        setUser(null);
        navigate('/');
        // Add any additional logout logic here, like API calls
    }
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                : (
                    <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:flex absolute top-10 right-0 bg-white shadow border border-gray-200 py-2.5 w-40 rounded-md text-sm z-40'>
